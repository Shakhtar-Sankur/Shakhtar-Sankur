...
🌐 [Site](https://shakhtar-sankur.github.io/gigzen/waggle.html) · 📱 [Download the APK](https://shakhtar-sankur.github.io/gigzen/Waggle-1.4.2.apk)
...
Version 1.4.2, signed, in closed testing. It is not on Google Play yet, so the APK installs from the
